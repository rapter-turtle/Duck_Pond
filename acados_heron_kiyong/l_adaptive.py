...
def L1_control(state, state_estim, param_filtered, dt, param_estim):
    ...
    pu = 1000000*dt*param_dynamics(state_error, before_param_estim[0], np.array([0, 0, 0, 1, 0]), 0.3) + before_param_estim[0]
    pr = 1000000*dt*param_dynamics(state_error, before_param_estim[1], np.array([0, 0, 0, 0, 1]), 0.8) + before_param_estim[1]
