...
def setup_wpt_tracking(x0,mode):
    ...
    # set constraints
    ocp.constraints.lbu = np.array([-8/1,-8/1])
    ocp.constraints.ubu = np.array([+25/1,+25/1])
    ocp.constraints.idxbu = np.array([0, 1])

    ocp.constraints.lbx = np.array([-ship_p.rmax, -8, -8])
    ocp.constraints.ubx = np.array([ship_p.rmax, 25, 25])
    ocp.constraints.idxbx = np.array([5, 6, 7])
