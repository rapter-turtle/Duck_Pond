...
def main(cbf_num,mode,prediction_horizon,gamma1, gamma2, target_speed):
    ...
    for i in range(Nsim):
        ...
        if mode == 'static':
            ox1 = 17; oy1 = +0.01; or1 = 10.0*obsrad_param
            ox2 = 17; oy2 = +0.01; or2 = 10.0*obsrad_param
            ox3 = 17; oy3 = +0.01; or3 = 10.0*obsrad_param
            ox4 = 17; oy4 = +0.01; or4 = 10.0*obsrad_param
            ox5 = 17; oy5 = +0.01; or5 = 10.0*obsrad_param
            obs_index = 1
...
if __name__ == '__main__':
    ...
    # ax_asv.set(xlim=(0, target_x),ylim=(-6,3))
    # # ax_asv.grid(True)
