...
if __name__ == '__main__':
    ...
    cd2, at2 ,sv2 ,con2, simX2, simU2, target_speed2, obs_array2, cbf_and_dist2, time_save2  = main(1,'static', 10, 0.25, 0.05, target_speed)
    ...
    # cd6, at6 ,sv6 ,con6, simX6, simU6, target_speed6, obs_array6, cbf_and_dist6, time_save6  = main(2,'static', 10, 0.00, 0.01, target_speed)
    # cd7, at7 ,sv7 ,con7, simX7, simU7, target_speed7, obs_array7, cbf_and_dist7, time_save7  = main(2,'static', 10, 0.00, 0.02, target_speed)
    # cd8, at8 ,sv8 ,con8, simX8, simU8, target_speed8, obs_array8, cbf_and_dist8, time_save8  = main(2,'static', 10, 0.00, 0.03, target_speed)
    # cd9, at9 ,sv9 ,con9, simX9, simU9, target_speed9, obs_array9, cbf_and_dist9, time_save9  = main(2,'static', 10, 0.00, 0.05, target_speed)
    ...
    fig.delaxes(axs[0, 1])
    # fig.delaxes(axs[0, 2])
    ax_asv = plt.subplot2grid((2, 3), (0, 0), colspan=2, rowspan=1)  # Combine first row for ASV
    ax_compt = axs[0, 2]
    ax_cbf3 = axs[1, 2]
    ax_surge = axs[1, 0]
    ax_rot = axs[1, 1]
    ...
    for idx, data in enumerate(sim_data):
        ...
        if idx == 0:
            lgd = r'$\alpha = 0.15, \alpha_e = 0.05$'
        elif idx == 1:             
            lgd = r'$\alpha = 0.25, \alpha_e = 0.05$'
        elif idx == 2:
            lgd = r'$\alpha = 0.50, \alpha_e = 0.05$'
        elif idx == 3:
            lgd = r'$\alpha = 0.25, \alpha_e = 0.01$'
        elif idx == 4:
            lgd = r'$\alpha = 0.25, \alpha_e = 0.10$'
    ...
    ax_asv.fill(a, b, facecolor='k', alpha=0.25, edgecolor='gray')
    ...
    ax_asv.set(xlim=(0, simX1[-1, 0]),ylim=(-8,2.5))
    # ax_asv.grid(True)
