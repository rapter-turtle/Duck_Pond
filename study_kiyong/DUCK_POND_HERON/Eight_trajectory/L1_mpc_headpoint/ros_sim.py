...
class ShipSimulator:
    def __init__(self):
        ...
        self.ship_state[0] = station_keeping_point[0] -20
        self.ship_state[1] = station_keeping_point[1] + 30
        self.ship_state[2] = 3.141592*0.7
    ...
    def control_callback(self, msg):
        ...
        self.control_input[0] = self.command_to_force(msg.left,1)
        self.control_input[1] = self.command_to_force(msg.right,2)
    ...
    def recover_simulator(self, ship, control_input, dt):
        ...
        n1, n2 = control_input[0]*(0.6 + 0.2*np.sin(self.k*0.2)), control_input[1]*0.9
        ...
        disturbance_head = np.array([disturbance_uv[0]*np.cos(psi) - disturbance_uv[1]*np.sin(psi), disturbance_uv[0]*np.sin(psi) + disturbance_uv[1]*np.cos(psi), 0.0])# print(disturbance_head[0]/M, disturbance_head[1]/M)
        ...
        # ship[6] = disturbance_head[0]/M
        # ship[7] = disturbance_head[1]/M
        self.k = self.k + 1
