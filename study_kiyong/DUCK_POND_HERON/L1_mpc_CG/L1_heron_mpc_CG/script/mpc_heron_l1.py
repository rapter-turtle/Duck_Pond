...
class HeronMPC:
    def __init__(self):
        ...
        self.theta=0.4*np.pi + np.pi/3#np.pi/2  # rotation angle in radians (pi/2 for 90 degrees)
        self.num_s_shapes=10.0  # number of S-shapes (sine wave cycles)
        self.start_point=(-5, 0)#(-5, -0)  # starting point of the trajectory
        ...
        self.Q_weight = [15, 15, 1e-1, 2, 0, 1e-3, 1e-4, 1e-4]
