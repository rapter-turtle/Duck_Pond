...
class HeronMPC:
    def __init__(self):
        ...
        self.Q_weight = [5, 5, 1, 1, 1, 0, 1e-4, 1e-4]
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Filtered
            obs_pos = np.array([self.x+100-offset[0], self.y+100-offset[1], 1, 
                                self.x+100-offset[0], self.y+100-offset[1], 1, du[0], dv[0], dr[0]])
            ...
            L1_data = [self.param_filtered[0]/M, self.param_filtered[1]/M, -self.param_filtered[2]/M, -self.param_filtered[1]/M, self.states[7], self.states[6], self.n2, self.n1]
            # print(L1_data)
