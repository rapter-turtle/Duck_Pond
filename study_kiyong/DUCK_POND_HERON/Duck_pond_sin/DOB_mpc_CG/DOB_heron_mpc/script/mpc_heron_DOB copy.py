...
class HeronMPC:
    def __init__(self):
        ...
        self.Q_weight = [2, 2, 0, 0, 0, 0, 1e-4, 1e-4]
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            for j in range(self.N+1):
                ...
                yref = np.hstack((refs[0],refs[1], 0, 0, 0, 0,0,0,0,0))
                # print(refs)
                if j == self.N:
                    yref = np.hstack((refs[0],refs[1], 0, 0, 0,0,0,0))
            ...
            # Filtered
            obs_pos = np.array([self.x+1000-offset[0], self.y+100-offset[1], 1, 
                                self.x+1000-offset[0], self.y+100-offset[1], 1, du[0], dv[0], dr[0]])
