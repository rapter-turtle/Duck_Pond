...
class SensorFusionEKF:
    ...
    def traj_callback(self, msg):
        ...
        if self.plot_traj != data :
            ...
            self.translation = (data[12], data[13])  # Translation offset for the trajectory
