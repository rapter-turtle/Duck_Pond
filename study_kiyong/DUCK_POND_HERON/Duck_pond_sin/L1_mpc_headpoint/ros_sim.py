...
class ShipSimulator:
    def __init__(self):
        ...
        self.ship_state[0] = station_keeping_point[0] + 7
        self.ship_state[1] = station_keeping_point[1] + 20
        self.ship_state[2] = 3.141592*0.8
    ...
    def recover_simulator(self, ship, control_input, dt):
        ...
        n1, n2 = control_input[0]*0.6, control_input[1]
        eps = 1e-5
