...
/* heron_impl_dae_jac_x_xdot_u_z:(i0[8],i1[8],i2[2],i3[],i4[],i5[6])->(o0[8x8,18nz],o1[8x8,8nz],o2[8x2,2nz],o3[8x0]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a2=1.5890672175433018e-01;
  if (res[0]!=0) res[0][12]=a2;
  a2=5.4495912806539502e-02;
