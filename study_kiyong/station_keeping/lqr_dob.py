...
class L1_LQR:
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.state_estim, self.param_estim, self.param_filtered, L1_thruster, x_error = L1_control(self.states, self.state_estim, self.param_filtered, self.con_dt, self.param_estim, self.desired_traj_straight)
            ...
            l1_msg.data = [self.state_estim[0], self.state_estim[1], self.state_estim[2], self.state_estim[3], 
                            self.param_estim[2], self.param_estim[3], self.param_filtered[2], self.param_filtered[3], 
