...
station_keeping_point = np.array([353118, 4026069])
...
class L1_LQR:
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.state_estim, self.param_estim, self.param_filtered, L1_thruster, x_error = L1_control(self.states, self.state_estim, self.param_filtered, self.con_dt, self.param_estim)
