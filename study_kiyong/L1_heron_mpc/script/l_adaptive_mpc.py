...
def L1_control(state, state_estim, param_filtered, dt, param_estim, mpc_con):
...
#                                 ((n1+n2)/M)*np.sin(psi)+ head_dist*((-n1+n2)*dist/I)*np.cos(psi)])
    ...
    # adaptive_control = - virtual_control[2:4] + nominal_control[2:4]
    adaptive_control = param_filtered[2:4] - virtual_control[2:4] + nominal_control[2:4]
    ...
    xdot = param_estim + param_filtered + nominal_control
    ...
    return x_t_plus, param_estim, param_filtered, adaptive_control
